...
export default function ActionRow({
  ...
  const secondary =
    "rounded-md border border-neutral-300 px-3 py-1.5 text-sm transition-colors duration-150 ease-out hover:border-blue-600 hover:text-blue-600 dark:border-neutral-700";
