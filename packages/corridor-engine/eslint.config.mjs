          ...
          patterns: [
            {
              ...
              message:
                "corridor-engine is pure: no Node builtins. Take data as arguments.",
            },
            {
              group: ["@h2map/*", "!@h2map/units", "!@h2map/corridor-schema"],
              message:
                "engine depends only on @h2map/units and @h2map/corridor-schema (one-way graph).",
            },
            {
              group: ["zod", "zod/*"],
              message:
                "validation lives in corridor-schema; the engine imports types only.",
            },
            {
              group: ["**/*.json"],
              message:
